...
public class ProcedureCoalGeneratorMk2Update extends ElementsMagmaTechMod.ModElement {
	public ProcedureCoalGeneratorMk2Update(ElementsMagmaTechMod instance) {
		super(instance, 15);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure CoalGeneratorMk2Update!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure CoalGeneratorMk2Update!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure CoalGeneratorMk2Update!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure CoalGeneratorMk2Update!");
			return;
		}
		...
		}.getAmount(new BlockPos((int) x, (int) y, (int) z), (int) (2))) * 0.15) + 1));
		...
		}.getAmount(new BlockPos((int) x, (int) y, (int) z), (int) (1))) * 0.25) + 1));
