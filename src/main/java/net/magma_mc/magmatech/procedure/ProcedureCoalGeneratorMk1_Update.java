...
public class ProcedureCoalGeneratorMk1_Update extends ElementsMagmaTechMod.ModElement {
	public ProcedureCoalGeneratorMk1_Update(ElementsMagmaTechMod instance) {
		super(instance, 14);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure CoalGeneratorMk1_Update!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure CoalGeneratorMk1_Update!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure CoalGeneratorMk1_Update!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure CoalGeneratorMk1_Update!");
			return;
		}
		...
		double Tick = 0;
		double Energy = 0;
		Generation = (double) 10;
		MaxBuffer = (double) 250;
		MaxMT = (double) 60000;
		...
		}.getAmount(new BlockPos((int) x, (int) y, (int) z), (int) (2))) * 0.05) + 1));
		...
		}.getAmount(new BlockPos((int) x, (int) y, (int) z), (int) (1))) * 0.15) + 1));
		...
		if ((((Tick) > 0) && ((Energy) < (MaxMT)))) {
			if (!world.isRemote) {
				...
				IBlockState _bs = world.getBlockState(_bp);
				if (_tileEntity != null)
					_tileEntity.getTileData().setDouble("MT", ((Energy) + ((Generation) * 2)));
				world.notifyBlockUpdate(_bp, _bs, _bs, 3);
			}
			Energy = (double) (new Object() {
				public double getValue(BlockPos pos, String tag) {
